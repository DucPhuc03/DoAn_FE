...
const Header = () => {
  ...
  // State for unread messages and meetings count
    ...
    const loadMeetingsCount = async () => {
      try {
        ...
        if (response?.code === 1000 && Array.isArray(response.data)) {
          // Count only active meetings (WAITING or SCHEDULED)
          const activeMeetings = response.data.filter(
            (m) => m.status === "WAITING" || m.status === "SCHEDULED"
          ).length;
          setMeetingsCount(activeMeetings);
        }
      } catch (error) {
        ...
        <div className="d-flex align-items-center justify-content-between py-3">
          ...
          <div className="d-flex align-items-center gap-5">
            ...
            <Link to="/" className="header-logo-container">
              <img
                src="https://traodoido.s3.ap-southeast-1.amazonaws.com/logo3.png"
                alt="logo"
