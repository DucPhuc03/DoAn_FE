      ...
      <div className="container py-4 py-md-5 post-detail-wrapper">
        <div className="row g-4">
          <div className="col-lg-6">
            <div className="detail-media card border-0 shadow-sm p-3">
            ...
            <div className="card border-0 shadow-sm media-meta mt-3">
          ...
          <div className="col-lg-6">
            <div className="card border-0 shadow-sm detail-card mb-4">
              <div className="card-body">
