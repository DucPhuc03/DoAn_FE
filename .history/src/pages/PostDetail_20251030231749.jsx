...
const post = {
  images: [
    "s3://traodoido/profile/1761838431539_58791216101f9d41c40e.jpg",
    "s3://traodoido/profile/1761838431539_58791216101f9d41c40e.jpg",
    "s3://traodoido/profile/1761838431539_58791216101f9d41c40e.jpg",
  ],
...
const PostDetail = () => {
  ...
  return (
    <div style={{ background: "#eef2f7", minHeight: "100vh" }}>
      <Header />
      <div
        style={{ maxWidth: 1120, margin: "0 auto", padding: "26px 16px 40px" }}
      >
        {/* Title Row */}
        <div
          style={{
        ...
        <div
          style={{
            display: "grid",
            gridTemplateColumns:
              "220px minmax(300px, 1.15fr) minmax(280px, 1fr)",
            gap: 24,
          }}
        >
          {/* Thumbnails */}
          ...
          <div>
            ...
            >
              ...
              <Section title="Description">
                <p style={{ color: "#2f3645", lineHeight: 1.6 }}>
                  {post.description}
                </p>
              </Section>
          ...
          {comments.map((c, i) => (
            ...
            >
              ...
              >
                ...
                <div
                  style={{ color: "#3b465b", fontSize: 15, lineHeight: 1.5 }}
                >
                  {c.content}
                </div>
              </div>
