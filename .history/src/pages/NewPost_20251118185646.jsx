      ...
      <div className="container py-4 py-md-5">
        <div className="text-center mb-4">
          ...
          <p className="text-muted mb-0">
            Chia sẻ món đồ bạn muốn trao đổi cùng cộng đồng.
          </p>
        </div>
            ...
            <div className="col-lg-5">
              ...
              >
                ...
                <p className="text-muted small mb-0">
                  Cho phép chọn nhiều ảnh cùng lúc (tối đa 5MB mỗi ảnh).
                </p>
              </div>
            ...
            <div className="col-lg-7">
              ...
              <div className="mb-3">
                ...
                <textarea
                  ...
                  placeholder="Mô tả món đồ hoặc viết lời nhắn công khai..."
              ...
              >
                ...
                {formData.meetingSpot ? (
                  ...
                  <p className="mb-0 text-danger small">
                    Bạn chưa có điểm gặp. Thêm ít nhất một điểm để nhiều người
                    thấy bài hơn.
                  </p>
                )}
                <input
